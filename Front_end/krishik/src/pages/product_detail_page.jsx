  ...
  if (!product) {
    return (
      <div className="mx-auto max-w-lg px-4 py-16 text-center">
        <p className="text-mist">Product not found.</p>
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-10 lg:grid-cols-2">
        <div className="overflow-hidden rounded-2xl border border-soil-200 bg-soil-100">
          <img
        ...
        <div>
          ...
          <h1 className="mt-3 font-display text-3xl font-bold text-bark sm:text-4xl">
            {product.name}
          </h1>
          ...
          {sellerId && (
            <Link
              to={`/farmers/${sellerId}`}
              className="mt-2 inline-flex items-center gap-1.5 text-sm text-mist hover:text-leaf-600"
            >
          ...
          <p className="mt-6 text-mist leading-relaxed">{product.description}</p>
          ...
          <p
            className={`mt-2 text-sm font-medium ${isInStock ? "text-leaf-600" : "text-red-600"}`}
          >
          ...
          {isInStock && (
            <div className="mt-6 flex flex-wrap items-center gap-4">
              <div>
                <p className="mb-2 text-sm font-semibold text-bark">Quantity</p>
                <QuantitySelector
                  value={quantity}
                  min={1}
                  max={stock}
